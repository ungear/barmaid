...
ingredientsStatistics.forEach(x => x.ingredientName = x.ingredientName[0].toUpperCase() + x.ingredientName.slice(1));

const ingredientsSorted = ingredientsStatistics.sort((a,b) => {
